...
const Hero = () => {
  ...
  const titles = ["Web App Developer", "AI & ML Enthusiast", "Tech Buddy", "Cloud Computing","Designing"];
  useEffect(() => {
        ...
        <div className="animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Dialog>
              ...
              <DialogContent className="fixed max-w-4xl w-[95vw] max-h-[85vh] overflow-hidden flex flex-col">
                <DialogHeader className="flex-shrink-0">
                  <DialogTitle className="text-2xl font-bold bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">
                    About Abhiram Kosuru
                  </DialogTitle>
                  <DialogDescription className="sr-only">
                    Detailed information about Abhiram Kosuru's education, experience, skills, and hobbies
                  </DialogDescription>
                </DialogHeader>
